/*********************************************************
 * Nehe lesson 10 modification which uses the touch screen
 * to control the camera and dpad to move the player.
 * Author: revo
 * Updated by Krikaliov (fork) - created the game
 ************************************************/
...
int DrawGLScene()
{
  ...
  glBindTexture(0, textures[SHOP_FLOOR_TEXT]);
